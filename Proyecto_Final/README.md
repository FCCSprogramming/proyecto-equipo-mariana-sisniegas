...
### Manejo de archivos
Se usa un archivo binario para almacenar los datos de los estudiantes y
un archivo de texto para exportar los estudiantes aprobados y acceso directo 
para leer un estudiante específico desde el archivo binario
